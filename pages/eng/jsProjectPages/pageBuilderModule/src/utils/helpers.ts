...
export function createIElement(elementTag: string): IElement {
    switch (elementTag) {
        case "text":
...
export function addUnits(...units: string[]): HTMLSelectElement {
...
export function setInitialUnits(unitSelector: HTMLSelectElement, value: string) {
