import { Color, direction, Moves, Piece, PieceType, square } from "../../types.js";
...
export class Pawn extends Piece {
    ...
    move(board: Board, square: square): void {
        ...
        if (this.coordinate[1] === 1 && square[1] === 3) board.enpassantSquare = add(this.coordinate, Moves.UP);
        if (this.coordinate[1] === 6 && square[1] === 4) board.enpassantSquare = add(this.coordinate, Moves.DOWN);
